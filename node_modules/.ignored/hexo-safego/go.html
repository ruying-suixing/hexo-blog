...
<head>
  ...
  {% if custom_css %}
  <link rel="stylesheet" href="{{ custom_css | noControlChars | uriencode }}">
  {% endif %}
  <title>安全跳转中...</title>
  <style type="text/css">
    * {
    ...
    .copy-btn:hover {
      color: #334155;
      box-shadow: 0 12px 24px rgba(100, 100, 100, 0.14);
    }
    ...
    .confirm-button {
      background: linear-gradient(135deg, #3fc1c9, #38a9b6);
      color: white;
      border-color: rgba(63, 193, 201, 0.18);
      box-shadow: 0 12px 24px rgba(63, 193, 201, 0.24);
    }
  ...
  <script type="text/javascript">
    ...
    function updateCountdown() {
      ...
      if (progressElement && {{countdown}} > 0) {
